...
(function() {
  ...
  $.awesomeCropper = function(inputAttachTo, options) {
    ...
    input = function(type) {
      return $(`<div class="image-field-haver"><input type = "${type}" class="custom-file-input"/><label class="custom-file-label" for="customFile">Choose Image</label></div>`);
    };
    div = function() {
      return $("<div/>");
    };
    ...
    image = function() {
      return $('<img class="cropped-image" />');
    };
    // Main box
