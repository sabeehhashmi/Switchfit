          ...
          <table class="table table-hover table-centered table-nowrap m-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <i class="mdi mdi-currency-gbp "></i>{{number_format((float)$s_booking->gym_owner_amount + $s_booking->switch_fit_fee, 2, '.', '')}}
                </td>

                <td>
                 @php

                 $percentage = ($s_booking->switch_fit_fee/$s_booking->sub_total)*100;
              ...
              <td>
                ...
                <i class="mdi mdi-currency-gbp "></i>{{number_format((float)$s_booking->gym_owner_amount, 2, '.', '')}}
