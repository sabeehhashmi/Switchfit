                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-2" style="margin-top: 35px;">
                        <div class="text-right">
                            <button type="submit" class="btn btn-md btn-add-gym">Add Category</button>
                        </div>
                    </div>
                </div>
            </form>
                            ...
                            <table id="datatable" class="table">
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        <td>{{$category->id}}</td>
                                        <td>{{$category->name}}</td>
                                        <td><img class="img-icon" src="{{asset($category->icon)}}" alt="icon"></td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="#"
                                                   onclick="questionNotification('Confirmation','Are You Sure ? You want to delete category?','{{route('category.delete',$category->id)}}')">
