            ...
            <tr>
                <td colspan="2">
                    <div class="order-detials-sec">
                        ...
                        <p style="padding:0;margin:0;">To Reset your password please visit following link.</p>

                        <br>
                        <br>

                        <a href="{{ url('/') }}/admin/confirm/password/{{$token}}" style="width: 100px;height: 40px;line-height: 40px;background-color: #432E92;border:0;color:#fff;border-radius: 5px;font-family:'Montserrat';font-size: 16px;margin:10px 0 0 0; padding: 10px;text-decoration: none;">Reset Password</a>
                    </td>
                </tr>
            </table>
            <table style="width:100%;">
